...
@Component({
  selector: 'ngx-suplimnetary-bill-sr',
  templateUrl: './suplimnetary-bill-sr.component.html',
  styleUrls: ['./suplimnetary-bill-sr.component.scss']
})
export class SuplimnetaryBillSrComponent implements OnInit {
  penaltysrList: any[] = [];
