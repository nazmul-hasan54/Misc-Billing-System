...
@Component({
  selector: 'ngx-total-loc-wise-minstry-arrear',
  templateUrl: './total-loc-wise-minstry-arrear.component.html',
  styleUrls: ['./total-loc-wise-minstry-arrear.component.scss']
})
export class TotalLocWiseMinstryArrearComponent implements OnInit {
