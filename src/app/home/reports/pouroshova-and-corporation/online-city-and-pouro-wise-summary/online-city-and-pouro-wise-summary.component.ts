...
import { OnlineCityPouroshovaWiseSummaryService } from '../../../../services/pdfGenerate/pouroshova-and-city-corporation/online-city-pouroshova-wise-summary.service';
...
@Component({
  selector: 'ngx-online-city-and-pouro-wise-summary',
  templateUrl: './online-city-and-pouro-wise-summary.component.html',
  styleUrls: ['./online-city-and-pouro-wise-summary.component.scss']
})
export class OnlineCityAndPouroWiseSummaryComponent implements OnInit {
  form: FormGroup;
  ...
  constructor(
    ...
    private _pdfService: OnlineCityPouroshovaWiseSummaryService,
  ...
  onReport() {
    ...
    if(this.fCon.reportType.value == '1'){
          this._service.getOnlineCityAndPouroWiseBnData(utilityObj.billMonth,this.fCon.zoneCode.value,this.fCon.locationCode.value,this.fCon.cityCorporationCode.value,this.fCon.pouroshovaCode.value,this.fCon.reportType.value).subscribe((res:any) => {
          ...
          if (this.onlinePouroshovaAndCityData.cityCoporationDataList != null &&  this.onlinePouroshovaAndCityData.pouroshovaDataList != null) {
            this.docData = this._pdfService.generatePdf(this.onlinePouroshovaAndCityData,this.fCon.billMonth.value,this.zoneDataList,this.cityCorporationDataList);
