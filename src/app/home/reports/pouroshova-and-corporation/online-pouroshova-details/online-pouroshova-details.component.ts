...
@Component({
  selector: 'ngx-online-pouroshova-details',
  templateUrl: './online-pouroshova-details.component.html',
  styleUrls: ['./online-pouroshova-details.component.scss']
})
export class OnlinePouroshovaDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    private _pdfDetailsService:OnlinePouroshovaDetailsService,
  ...
  onChangeExportType(event: any) {
    if (event == 1) {
      let date = new Date();
      let fileName =
      "Online Pouroshova Details Report" +
