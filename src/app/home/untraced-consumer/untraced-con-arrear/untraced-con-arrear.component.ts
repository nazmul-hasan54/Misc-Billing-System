...
@Component({
  selector: "ngx-untraced-con-arrear",
  templateUrl: "./untraced-con-arrear.component.html",
  styleUrls: ["./untraced-con-arrear.component.scss"],
})
export class UntracedConArrearComponent implements OnInit {
  ...
  constructor(
    private _pdfService: UntracedCustArrearService,
  ...
  onReport() {
    ...
    this._untracedConService
      .getUntracedCustArrearCollection(
      ...
      .subscribe(
        (res) => {
          this.customerList = res as UntracebleCustArrearReportModel[];
