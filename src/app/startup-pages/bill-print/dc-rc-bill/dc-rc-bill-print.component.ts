...
@Component({
  selector: 'ngx-dc-rc-bill-print',
  templateUrl: './dc-rc-bill-print.component.html',
  styleUrls: ['./dc-rc-bill-print.component.scss']
})
export class DcRcBillPrintComponent implements OnInit {
  ...
  constructor(
    ...
    private _dcRcBillService: ReportBillService,
