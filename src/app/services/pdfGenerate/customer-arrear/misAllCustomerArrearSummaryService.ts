...
export class misAllCustomerArrearSummaryService {

  constructor() { }
  defaultColor = "";
  // calling location wise
  generateLocationWisePdf(data: any, billMonth: string, centerName: string) {
  ...
  private getDocumentDefinition(data: any, billMonth: any, centerName: string) {
    return {
      info: {
  ...
  private getLocationWiseHeading(data: any, billMonth: any, centerName: string) {
  ...
  private getAllCustomerArrearSummaryLocationInfo(data: any) {
    const phases = {
      table: {
        dontBreakRows: true,
        headerRows: 1,
