...
export class MinistryWiseCustListService {
  ...
  private getDocumentDefinition(data:any, reportObject:any) {
    return {
      info: {
        title: 'Agriculture Ministry Consumer',
        author: 'BPDB',
        subject: 'Agriculture Ministry Consumer',
      ...
      content: [this.getHeading(data,reportObject), this.getMinistryWiseAgriculture(data),],
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {},
            {
              text: [`কৃষি মন্ত্রণালয়ের গ্রাহক তালিকা ।`],
              style: [setSubHeading],
              margin: [0, -2, 0, 0],
              colSpan: 5,
            },
          ...
          [
            ...
            {},
            {
              text:`মোট গ্রাহক : ${this.translateNumber(data.length,2)}`,
              style: [setSubSetHeading],
              margin: [0, 0, 0, 0],
              colSpan: 2,
            },
  ...
  private getMinistryWiseAgriculture(data: any){
    const {TotalDues}=data;
    const phases = {
      margin: [0, -20, 0, 0],
      table: {
        headerRows: 1,
        widths: [20, 100, 25, '*', 100,'auto'],
        body: [
          [
            {
    ...
    uniqueKrishiLocations.forEach((location) => {
      ...
      if(customerGroupByLocationLength>0){
        ...
        customerGroupByLocation.forEach(cust => {
          ...
          totalArrearAmount = currentReceiptArrear ? this.translateNumber(currentReceiptArrear.toFixed(2)) : this.translateNumber(0.00);
          // arrearAmt = currentReceiptArrear ? currentReceiptArrear: 0.00;
