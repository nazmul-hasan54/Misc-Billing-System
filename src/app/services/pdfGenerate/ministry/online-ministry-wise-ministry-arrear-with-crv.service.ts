...
export class OnlineMinistryWiseMinistryArrearWithCrvService {
...
private getDocumentDefinition(data: any, reportObj: any) {
  return {
    ...
    content: [
      this.getOnlineMinistryArrearReport(data, reportObj)
    ],
...
getOnlineMinistryArrearReport(data:any,reportObj:any){
  let billMonth = reportObj.billMonth;
