...
export class ModPrepaidCustomerService {
  setColor: string = "";
  marginTop = [0, 1, 0, 0];
  constructor() { }
  ...
  private getModPrepaidCustomerInfo(data: any) {
    const phase = {
      ...
      table: {
        dontBreakRows: true,
        headerRows: 1,
        widths: [15,55,60,'*',60,70,60,55,60,60,50,40,50,50,40,40],
        body: [
          [
            {
              text: `SN`,
    ...
    data.forEach(value => {
      ...
      phase.table.body.push(
        [
          ...
          {
            text: `${(value.lastReadingSr-value.lastBillReadingSr).toFixed(2)}`,
            style: [],
            border: [true, true, true, true],
            lineHeight: 1,
            margin: [0, 8, 0, 0],
          ...
          {
            text: `${(value.lastReadingPk-value.lastBillReadingPk)}`,
            style: [],
            border: [true, true, true, true],
            lineHeight: 1,
            margin: [0, 8, 0, 0],
          ...
          {
            text: `${(value.lastReadingOpk-value.lastBillReadingOpk)}`,
            style: [],
            border: [true, true, true, true],
            lineHeight: 1,
            margin: [0, 8, 0, 0],
