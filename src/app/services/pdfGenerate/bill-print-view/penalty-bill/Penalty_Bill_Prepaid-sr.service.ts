...
export class ReportBillPrepaidSrService {
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              style: ['setTitleBold', 'setLeft'], text: 'PENALTY BILL PREPAID', bold: true, margin: [-35, -20, 0, 0],
              color: 'green',
              colSpan: 2
            },
          ...
          [
            ...
            {},
            {
              //text: data.paid.toUpperCase() == "PAID" ? "" : `Balance: ${data.totalAmount}, PRN: ${data.principleAmount}, Vat: ${data.vatAmount}`,
      ...
      table: {
        ...
        body: [
          [
            ...
            // { border: [true, true, true, false], text: "PENALTY UNIT", style: ['', 'setRight'] },
            // {
  ...
  private getDuesInformation(data: any) {
    let locationPath=`https://infonetlimited.com/portal/startup/penalty-bill-sr/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
