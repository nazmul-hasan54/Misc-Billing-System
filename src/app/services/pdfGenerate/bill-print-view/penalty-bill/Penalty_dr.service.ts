...
export class ReportBillDrService {
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              style: ['setTitleBold', 'setLeft'], text: 'PENALTY BILL', bold: true, margin: [-35, -20, 0, 0],
              color: 'green',
              colSpan: 2
            },
      ...
      table: {
        ...
        body: [
          [
            ...
            { border: [true, true, true, false], text: "PENALTY OFF PEAK UNIT", style: ['', 'setRight'] },
            {
          ...
          [
            ...
            { border: [true, false, true, false], text: " PENALTY PEAK UNIT", style: ['', 'setRight'] },
            {
  ...
  private getDuesInformation(data: any) {
    ...
    let locationPath=`https://infonetlimited.com/portal/startup/penalty-bill-dr/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
