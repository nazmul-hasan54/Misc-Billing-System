...
export class SupplementaryDrBillService {
      ...
      table: {
        ...
        body: [
          [
            ...
            { border: [true, true, true, false], text: "SUPPLEMENTARY OFF PEAK UNIT", style: ['', 'setRight'] },
            {
      ...
      return {
        ...
        table: {
          ...
          body: [
            ...
            // row-2
            [
              { border: [true, false, true, false], style: ['setRight'], text: "ELECTRICITY CHARGE", rowSpan: 3, },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[0].principleAmount
              },
