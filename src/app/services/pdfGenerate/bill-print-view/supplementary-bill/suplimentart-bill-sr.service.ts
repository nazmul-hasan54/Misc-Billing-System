...
export class SuplimentartBillSrService {
      ...
      table: {
        ...
        body: [
          [
            ...
            { border: [true, true, true, false], text: "SUPLIMENTARY UNIT", style: ['', 'setRight'] },
            {
  ...
  private getDuesInformation(data: any) {
    ...
    //let locationPath=`https://infonetlimited.com/portal/startup/suplimentary-bill-sr/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
    let locationPath=`http://localhost:4200/startup/suplimentary-bill-sr/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
