...
export class SupplementaryBillService {
  setColor: string = "";
  marginTop = [0, 1, 0, 0];
  constructor() { }
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              style: ['setTitleBold', 'setLeft'], text: 'SUPPLEMENTARY', bold: true, margin: [-57, -20, 0, 0],
              color: 'red',
              colSpan: 2
            },
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              { text: "TAKA" },
              { style: ['setCenter'], text: "INSTALLMENT DUE DATE" },
            ],
            // row-2
            [
              ...
              { border: [true, false, true, false], style: ['setRight'], text: "1ST INSTALLMENT LPS" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
            ...
            [
              { border: [true, false, true, false], style: ['setCenter'], text: "" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: ''
              },
              { border: [true, false, true, false], style: ['setRight'], text: "2ND INSTALLMENT LPS" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
            ...
            [
              ...
              { border: [true, false, true, false], style: ['setRight'], text: "3RD INSTALLMENT LPS" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[2].totalInstallmentTaka ?? 0, rowSpan: 3
              },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[2].installmentDueDate ?? '', rowSpan: 4
              },
            ],
            // [
            ...
            //   {
            //     border: [true, false, true, false], style: ['setRight', 'setBlack'],
            //     text: DEMAND_CHRG.toFixed(2) ?? 0.00
            //   },
            ...
            [
              { text: " TOTAL BILL", style: ['setCenter', 'setColumnBold'], },
              {
                style: ['setRight', 'setBlack'],
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              { border: [true, false, true, false], style: ['setRight'], text: "2ST INSTALLMENT LPS" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[1].totalInstallmentTaka ?? 0
              },
            ...
            [
              ...
              { border: [true, false, true, false], style: ['setRight'], text: "" },
              {
                border: [true, false, false, false], style: ['setRight', 'setBlack'],
                text: ''
              },
              { text: "", border: [true, false, true, false] },
    ...
    if (uptoTotal == 0) {
      return {
        ...
        table: {
          ...
          body: [
            [
              { border: [true, true, true, true], text: "PAYMENT DETAILS", colSpan: 2, margin: [-60, 2, 285, 20] },
              {
