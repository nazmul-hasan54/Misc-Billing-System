...
export class SuplimentartBillDrService {
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              style: ['setTitleBold', 'setLeft'], text: 'SUPLIMENTARY BILL', bold: true, margin: [-57, -20, 0, 0],
              color: 'green',
              colSpan: 2
            },
          ...
          [
            {
              style: ['setBlack', "setLeft"], text: data.locationName ?? "", bold: true, margin: [20, -10, 0, 0],
              colSpan: 2
            },
            {},
            {
    ...
    return {
      table: {
        ...
        body: [
          ...
          // row-2
          [
            { border: [true, false, true, false], style: ['setBlack', 'setLeft'], text: data.fatherName ?? "", colSpan: 4, rowSpan: 2, margin: [0, 0, 0, 0] },
            {},
            {},
            {},
          ...
          // row-4
          [
            { border: [true, false, true, false], style: ['setBlack', 'setLeft'], text: data.customerAddress ?? "", colSpan: 4, rowSpan: 4, margin: [5, 0, 0, 0] },
            {},
            {},
            {},
          ...
          // row-5
          [
            { border: [true, true, true, true], style: ['setBlack', 'setLeft'], text: '', colSpan: 4, margin: [5, 0, 0, 0] },
            {},
            {},
            {},
          ...
          // row-6
          [
            { border: [true, true, true, false], style: ['setBlack', 'setLeft'], text: '', colSpan: 4, margin: [5, 0, 0, 0] },
            {},
      ...
      table: {
        ...
        body: [
          [
            ...
            { border: [true, true, true, false], text: "SUPLIMENTARY OFF PEAK UNIT", style: ['', 'setRight'] },
            {
              border: [true, true, true, false],
              style: ['setBlack', 'setRight'], text: data.offPeakUnit ?? ""
            },
          ...
          [
            ...
            { border: [true, false, true, false], text: " SUPLIMENTARY PEAK UNIT", style: ['', 'setRight'] },
            {
          ...
          [
            { border: [true, false, true, true], text: "REMARKS", style: ['', 'setLeft'] },
            {
      ...
      return {
        ...
        table: {
          ...
          body: [
            ...
            // row-2
            [
              { border: [true, false, true, false], style: ['setRight'], text: "OFF PEAK ELECTRICITY CHARGE"},
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[0].offPeakAmount
              },
            ...
            [
              { border: [true, false, true, false], style: ['setRight'], text: "PEAK ELECTRICITY CHARGE" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[0].peakAmount
              },
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              { border: [true, false, true, false], style: ['setRight'], text: "No Installment " },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[0].totalInstallmentTaka ?? 0
              },
  ...
  private getDuesInformation(data: any) {
    ...
    //let locationPath=`https://infonetlimited.com/portal/startup/suplimentary-bill-dr/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
    let locationPath=`http://localhost:4200/startup/suplimentary-bill-dr/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
