...
export class DcRcService {
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              style: ['setTitleBold', 'setLeft'], text: 'DISCONNECTIONC/RECONNECTION', bold: true, margin: [-90, -20, 0, 0],
              color: 'green',
              colSpan: 2
            },
  ...
  private getDuesInformation(data: any) {
    ...
    //let locationPath=`https://infonetlimited.com/portal/startup/dc-rc-bill-print/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
    let locationPath=`http://localhost:4200/startup/dc-rc-bill-print/${data[0].billNumber}${data[0].billCheckDigit}/${data[0].customerNumber}`;
