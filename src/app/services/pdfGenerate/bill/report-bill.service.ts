    ...
    return {
      table: {
        ...
        body: [
          ...
          // row-4
          [
            { border: [true, false, true, false], style: ['setBlack', 'setLeft'], text: data.customerAddress ?? "", colSpan: 4, margin: [0, 0, 0, 0] },
            {},
            {},
            {},
  ...
  private getMeterUnit(data: PenaltyBillPrintModel) {
    ...
    return {
      ...
      table: {
        ...
        body: [
          [
            { border: [true, true, true, false], text: "CUSTOMER MOBILE" },
            {
            ...
            { border: [true, true, true, false], text: "PENALTY UNIT" },
            {
              border: [true, true, true, false],
              style: ['setBlack', 'setRight'], text:  data.penaltyUnit ?? ""
            },
            { border: [true, true, true, false], text: "NO OF INSTALLMENT" },
            { text: data.installmentNo ?? '', rowSpan: 3 },
          ],
          [
            { border: [true, false, true, false], text: "NID NUMBER" },
            {
          ...
          [
            { border: [true, false, true, false], text: "IMPOSED BY" },
            {
              border: [true, false, true, false], margin: [10, 0, 0, 0], style: ['setBlack', 'setLeft'],
              text: data.imposedBy ?? ""
            },
          ...
          [
            { border: [true, false, true, true], text: "REASON" },
            {
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              { border: [true, false, true, false], style: ['setRight'], text: "2ST INSTALLMENT WITH LPS" },
              {
                border: [true, false, true, false], style: ['setRight', 'setBlack'],
                text: data[1].totalInstallmentTaka ?? 0
              },
    ...
    if (uptoTotal == 0) {
      return {
        ...
        table: {
          ...
          body: [
            [
              { border: [true, true, true, true], text: "PAYMENT DETAILS", colSpan: 2, rowSpan: 2, margin: [-100, 2, 285, 20] },
              {
