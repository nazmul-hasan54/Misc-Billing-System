...
export class OnlineCityPouroCrvDetailsService {
 ...
 private getDocumentDefinition(data: any, reportObj: any) {
  return {
    info: {
      title: 'Online Pouroshova and City Corporation CRV Details',
      author: 'BPDB',
      subject: 'Online Pouroshova and City Corporation CRV Details',
