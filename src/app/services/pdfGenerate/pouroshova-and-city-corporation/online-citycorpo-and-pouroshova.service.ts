...
import { ministryDetailsDefaultStyle, ministryDetailsHeaderMargin, ministryDetailsImageMargin, ministryDetailsPageMargin, ministryDetailsStyle, setHeading, setPdfMakeFonts, setPouroshovaAndCityStyle, setSubHeading, setSubSetHeading, } from '../config/pdfMakeConfig';
...
export class OnlineCitycorpoAndPouroshovaService {

  defaultColor = '#111';
  constructor() { }


  generatePdf(data: any, reportObj: any, zoneData: any, cityCorporationData: any,billcycle:any) {
    //@ts-ignore
   pdfMake.fonts = setPdfMakeFonts;

   const documentDefinition = this.getDocumentDefinition(data,reportObj, zoneData, cityCorporationData,billcycle);
    //@ts-ignore
   return pdfMake.createPdf(documentDefinition);
 }

  private getDocumentDefinition(data: any, reportObj: any, zoneData: any, cityCorporationData: any,billcycle:any) {
    return {
      info: {
      ...
      content: [
        this.getOnlineMunicipalZoneSummaryReport(data, reportObj, zoneData, cityCorporationData,billcycle)
      ],
  ...
  private getOnlineMunicipalZoneSummaryReport(data: any, reportObj: any, zoneData: any, cityCorporationData: any,billcycle:any) {
    ...
    removeNulluniqueCityCorporationData.forEach((cityCorpo)=>{
        ...
        if(CityCorporationGroupByLength>0){
          CityCorporationGroupBy.forEach(city=>{
            ...
            // if(city.zoneCode=='1' && billcycle=='202309' ){
            //   cityArrPrevAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear +490000 ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat;
            // cityArrMonthAmount = currPrin+currLps+currVat;
            // }
            // else if(city.zoneCode=='1' && billcycle>'202309' ){
            //   cityArrPrevAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear +690000 ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat ;
            // cityArrMonthAmount = currPrin+currLps+currVat-690000;
            // }
            // else if (city.zoneCode=='4' && billcycle>'202309'){
            //   cityArrPrevAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-6650000  ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat ;
            // cityArrMonthAmount = currPrin+currLps+currVat +6650000;
              
            // }
            // else if (city.zoneCode=='3' && billcycle=='202311'){
            //   cityArrPrevAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear+260000  ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat ;
            // cityArrMonthAmount = currPrin+currLps+currVat -260000
            // ;
      ...
      phases.table.body.push(
        [
          ...
          {
            text: this.translateNumber(Number(allCityArrPrevAmountTotal / 10000000 >0 ? allCityArrPrevAmountTotal / 10000000:0).toFixed(3)),
            style: ['setBlack', 'setRight', 'setBold'],
            border: [false, true, true, true],
          },
          {
            text: this.translateNumber(Number(allCityArrMonthAmountTotal / 10000000 >0 ? allCityArrMonthAmountTotal / 10000000:0).toFixed(3)),
            style: ['setBlack', 'setRight', 'setBold'],
            border: [false, true, true, true],
          },
          {
            text: this.translateNumber(Number(allCityTotalReceiptAmountTotal / 10000000 >0 ? allCityTotalReceiptAmountTotal / 10000000:0).toFixed(3)),
            style: ['setBlack', 'setRight', 'setBold'],
            border: [false, true, true, true],
          },
          {
      ...
      uniqueZone.forEach((zone)=>{
        ...
        if(pouroshovaGroupByZoneLength>0){
          ...
          console.log("removeNullPouroshovaDataList",removeNullPouroshovaDataList)
          ...
          removeNullPouroshovaDataList.forEach(pouro=>{
            ...
            no += 1;
            providerNo += 1;
            // if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='28'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-10990000  ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +10990000;
              
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='29'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-400000  ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +400000;
              
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='30'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-80000              ;
            // //cityTotalReceiptAmount = currReceiptPrincipal + currReceiptVat+490000;
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +80000            ;
              
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='31'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-380000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +380000 ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='32'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-630000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +630000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='33'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-18540000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +18540000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='34'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-360000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +360000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='36'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-1980000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +1980000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='38'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-370000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +370000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='40'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-290000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +290000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='41'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-210000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +210000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='42'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-80000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +80000;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='46'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-18600000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +18600000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='47'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-3280000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +3280000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='48'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-5400000 
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +5400000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='56'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-70000
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +70000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='61'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-10000
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +10000            ;
            // }
            // else if (pouro.zoneCode=='4' && billcycle>'202309' && pouro.pouroshovaCode=='27'){
            //   pouroPrevArrAmount = arrearPrincipal+arrearLps+arrearVat- totalReceiptArrear-10000
            // pouroTotalReceiptAmt = currReceiptPrincipal + currReceiptVat ;
            // pouroCurrMonthArr = currPrin+currLps+currVat +10000            ;
            // }
