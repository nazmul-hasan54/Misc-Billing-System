...
import { ministryDetailsDefaultStyle, ministryDetailsHeaderMargin, ministryDetailsImageMargin, ministryDetailsPageMargin, ministryDetailsStyle, misAllMinistryCenterwiseSummaryDefaultStyle, misAllMinistryCenterwiseSummaryPageMargin, misMinistrySummaryHeaderMargin, misMinistrySummaryStyle, setHeading, setPdfMakeFonts, setPouroshovaAndCityStyle, setSubHeading, setSubSetHeading, } from '../config/pdfMakeConfig';
...
export class OnlineCitycorpoPouroshovaDetailsService {
 ...
 private getDocumentDefinition(data: any, reportObj: any) {
  return {
    info: {
      title: 'Online Pouroshova and City Corporation Details',
      author: 'BPDB',
      subject: 'Online Pouroshova and City Corporation Details',
    ...
    header: this.getOnlineCitycorporationAndPouroshovaDetailsHeading(data,reportObj),
    content: [
      this.getOnlineCitycorporationAndPouroshovaDetailsReport(data, reportObj)
    ],
  ...
  private getOnlineCitycorporationAndPouroshovaDetailsHeading(data:any,reportObj: any){
    
  let cityCorporation=data.filter(p=>p.cityCorporationCode!=' ')
  let pouroshova=data.filter(p=>p.pouroshovaCode!=' ')
  let totalCustomer = (cityCorporation.length+pouroshova.length);
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {},
            {
              text: `City Corporation and Pouroshova Receipt Details`,
  ...
  private getOnlineCitycorporationAndPouroshovaDetailsReport(data: any, reportObj: any) {
    ...
    if(cityCorporation.length>0)
    {
      ...
      uniqueCityCorporation.forEach((cityDate)=>{
        let customerGroupByCityCorporation=cityCorporation.filter(x=>x.cityCorporationCode==cityDate)
      ...
      phases.table.body.push(
        [
          ...
          {
            text: `${(cityTotalPreviousReceiptArrear).toFixed(2)}`,
            style: ['setBlack','setBold'],
            border: [true, true, true, true],
            margin: [0, 0, 0, 0],
            colSpan: 1
          ...
          {
            text: `${(cityTotalCurrentMonthBill).toFixed(2)}`,
            style: ['setBlack','setBold'],
            border: [true, true, true, true],
            margin: [0, 0, 0, 0],
            colSpan: 1
          ...
          {
            text: `${(cityTotalReceipt).toFixed(2)}`,
            style: ['setBlack','setBold'],
            border: [true, true, true, true],
            margin: [0, 0, 0, 0],
            colSpan: 1
    ...
    if(pouroshova.length>0){
      let uniquePouroshova=[...new Set(pouroshova.map(item=>item.pouroshovaCode))];
      

        uniquePouroshova.forEach((cityDate)=>{
          let customerGroupByPouroshova=pouroshova.filter(x=>x.pouroshovaCode==cityDate)
