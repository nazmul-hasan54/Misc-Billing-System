...
export class PouroshovaDetailsService {
  ...
  private getDocumentDefinition(data: any, reportObj: any, utilityObj: any) {
    return {
      info: {
        title: 'Pouroshova Details ',
        author: 'BPDB',
        subject: 'Pouroshova Details',
      ...
      content: [ this.getPouroshovaDetails(data, reportObj, utilityObj)],
  ...
  private getHeading(data: any, reportObj: any, utilityObj: any){
    let totalCount=  data.filter(c=>c.pouroshovacode != null).length;
  ...
  private getPouroshovaDetails(data: any, reportObj: any, utilityObj: any){
    ...
    let removeNulluniquePouroshovaData = uniquePouroshova.filter(n => n);
        ...
        pouroshovaDetailsData.forEach(value => {
          ...
          if(value.pouroshovacode != null){
            pouroPrnTotal += value.prn;
            pouroLpsTotal += value.lps;
            pouroVatTotal += value.vat;
