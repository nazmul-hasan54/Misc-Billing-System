...
export class OnlinePoliceDetailsService {
 ...
 private getDocumentDefinition(data: any, reportObj: any) {
  return {
    info: { 
      title: 'Online Police Arrear Details',
      author: 'BPDB',
      subject: 'Online Police Arrear Details',
    ...
    header: this.getOnlinePoliceArrearDetailsHeading(data, reportObj),
    content: [
      this.getOnlinePoliceArrearDetailsReport(data, reportObj)
    ],
...
private getOnlinePoliceArrearDetailsHeading(data:any, reportObj){
  ...
  private getOnlinePoliceArrearDetailsReport(data: any, reportObj: any) {
